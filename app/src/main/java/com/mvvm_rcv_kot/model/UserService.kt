...
/*Слушатели (Listeners): Этот класс использует систему слушателей,
чтобы оповещать об изменениях в списке пользователей. С помощью
методов addListener и removeListener вы можете подписаться или отписаться
от уведомлений. При любых изменениях в списке пользователей (например,
